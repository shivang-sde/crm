...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request payload for creating a deal line item")
public class DealLineItemCreateRequest {

    @Schema(description = "Offering UUID to snapshot into the deal line item")
