...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request payload for creating a deal stage")
public class DealStageCreateRequest {

    @NotBlank(message = "Stage name is required")
    @Schema(description = "Stage name", example = "Qualification")
    private String name;

    @Schema(description = "Stage color", example = "#FF5733")
