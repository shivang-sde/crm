...
@NoArgsConstructor
@AllArgsConstructor
@Schema(name = "ContactCreateRequest", description = "Request to create a new contact")
public class ContactCreateRequest {

    @NotNull(message = "Account ID is required")
    @Schema(description = "UUID of the parent account")
    ...
    @Schema(description = "Lead UUID this contact was created from")
    private UUID leadId;
